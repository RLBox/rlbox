class ApplicationController < ActionController::Base
  # ADR-013 Track D：将常量文件显式 require 进来，因为 app/validators/support 被
  # Zeitwerk ignore（见 config/application.rb），这个路径下的常量不会自动加载。
  require Rails.root.join('app/validators/support/data_packs/v1/_constants/demo_user_constants').to_s
  ...
  def auto_login_default_user
    user = User.find_by!(email: DataPacks::V1::DemoUser::EMAIL)
